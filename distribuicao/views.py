...
def configurar_distribuicao(request):
    ...
    table_data_estatisticas = [
        ...
        ['<div class="text-center">6 - ESPECÍFICO LICENÇA, VRE, CLI</div>', 
         ...
         '<div class="text-center">ESPECIFICO LICENCA, VRE, CLI,80</div>'],
    ...
    table_data_atendentes = [
        ['<div class="text-center">Segunda Via IPTU</div>',
        ...
        ['<div class="text-center">Licenças em Geral/VRE</div>',
        ...
        ['<div class="text-center">Ordem de Anexos/Processos SEI</div>',
        ...
        ['<div class="text-center">ITBI / ISS</div>',
